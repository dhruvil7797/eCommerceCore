    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<LoginResponse> Post([FromBody] LoginData ld)
        {
            ...
            try
            {
                ...
                var userCredential = context.UserCredential.FirstOrDefault(u => u.Password == ld.Password);

                if (user != null )
                {
                    if (PasswordHash.VerifyHashedPassword(userCredential.Password, ld.Password))
                    {
